...
export default function AddProductPage() {
    ...
    const { createProduct, isLoading: isSubmitting } = useProductStore();
    ...
    const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Create previews and initial colors
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await createProduct(productPayload, images);
            ...
            toast.error("Failed to publish masterpiece");
        }
    };
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-4xl font-serif text-luxury-text">Add New Masterpiece</h1>
                        <p className="text-luxury-muted font-light italic">"Every thread tells a story of Himalayan heritage."</p>
                    </div>
                </div>
